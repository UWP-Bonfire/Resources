...
PR no. 27 (Android)
-    **PR Title: Refactor defineBottomNavButtons()
-    **PR Link: [UWP-Bonfire/Bonfire-Android#27](https://github.com/UWP-Bonfire/Bonfire-Android/pull/27)
-    **Author: Caleb Geisler
-    **Reviewers:Courtney Walk
